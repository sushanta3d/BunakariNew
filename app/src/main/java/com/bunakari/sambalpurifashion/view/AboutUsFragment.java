...
public class AboutUsFragment extends Fragment {
    ...
    private void initUi(View v) {
        aboutWebView = v.findViewById(R.id.aboutWebView);
        notfoundTextView = v.findViewById(R.id.notfoundTextView);
        progressBar = v.findViewById(R.id.progressBar);
    }

    private void GetAboutData(){
        ApiService aboutService = RetroClass.getApiService();
        Call<SingleResponse> aboutStringCall = aboutService.getAboutUs();
        aboutStringCall.enqueue(new Callback<SingleResponse>() {
            @Override
            public void onResponse(Call<SingleResponse> call, Response<SingleResponse> response) {
                ...
                if (singleResponse != null) {
                    aboutWebView.loadData(singleResponse.content,"text/html",null);
                }else {
